...
import heroPhoto2 from '../../public/mdfLarge.png'
import heroPhoto3 from '../../public/mdfLarger.png'
import mdfLogo from "../../public/mdfLogo.png"
...
function Hero() {
  ...
  return (<>
    <div style={{
      ...
      <div className="hidden lg:block"><Image src={heroPhoto} alt="Snow" /></div>
      <div className="md:block lg:hidden object-cover"><Image src={heroPhoto3} /></div>
      <div style={{
        position: "absolute",
        top: "50%",
        left: "50%",
        ...
        <h1 className="md:text-9xl sm:text-9xl text-7xl font-bold text-gray-100 flex flex-col jusitfy-center items-center">
          Mike Drop Fades
        <Image src={mdfLogo} />
        </h1>
        </div>
